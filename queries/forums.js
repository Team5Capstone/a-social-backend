...
const createForum = async (forum) => {
  try {
    const query =
      "INSERT INTO forums (forum_title, forum_description, forum_posts, user_id, category_id, badge_id) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *";
...
const updateForum = async (id, forum) => {
  try {
    const query =
      "UPDATE forums SET forum_title = $1, forum_description = $2, forum_posts = $3, user_id = $4, category_id = $5, badge_id = $6 WHERE id = $7 RETURNING *";
